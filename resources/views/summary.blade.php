        ...
        <div class="col-md-8 mt-5 bdo-summary mb-5">
            <div class="card">
                <ul class="list-group list-group-flush text-center">
                    ...
                    <li class="list-group-item"><strong>Activity Max Budget:</strong><br>€ 150</li>
                    ...
                    <li class="list-group-item"><strong>Activities selected</strong><br>Be the local<br>Beer and Czech Tapas Trail<br>Cooking class<br>Uplands Off-Road<br>Squash</li>
